...
public class Venues {
	...
	private String emkit_location_id = "";  
	...
	public String getEmkit_location_id() {
		return emkit_location_id;
	}
	public void setEmkit_location_id(String emkit_location_id) {
		this.emkit_location_id = emkit_location_id;
	}
