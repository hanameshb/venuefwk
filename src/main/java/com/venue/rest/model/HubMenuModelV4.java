...
public class HubMenuModelV4 {
	...
	private ArrayList<HubSubMenuModelV4> subMenuList=null;
	...
	public ArrayList<HubSubMenuModelV4> getSubMenuList() {
		return subMenuList;
	}
	public void setSubMenuList(ArrayList<HubSubMenuModelV4> subMenuList) {
