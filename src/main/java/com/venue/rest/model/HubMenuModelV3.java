...
public class HubMenuModelV3 {
	...
	private ArrayList<HubSubMenuModelV3> subMenuList=null;
	...
	public ArrayList<HubSubMenuModelV3> getSubMenuList() {
		return subMenuList;
	}
	public void setSubMenuList(ArrayList<HubSubMenuModelV3> subMenuList) {
